        ...
        <div className="flex flex-col items-start justify-between gap-10 border-t border-white/16 pt-10 md:flex-row md:items-center">
          <div>
            <p className="font-serif text-4xl font-black uppercase leading-none">
              Eli<span className="text-[#ffdcf7]">.</span>
            </p>
          ...
          >
            {navItems.map((item) => (
              <a key={item.href} href={item.href} className="transition hover:text-[#ffdcf7]">
                {item.label}
              </a>
            ))}
          </nav>
          ...
          <div className="flex items-center gap-5">
            <a
              ...
              className="text-white/62 transition hover:text-[#ffdcf7]"
            >
